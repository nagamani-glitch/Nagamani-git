...
//     // If status changed to Approved or Rejected, create a notification and emit a socket event
//     if (status && status !== previousStatus && 
//         (status === 'Approved' || status === 'Rejected') && 
//         timeOffRequest.userId) {
      
//       // Create a notification in the database
//       const notificationMessage = `Your time off request for ${new Date(timeOffRequest.date).toLocaleDateString()} has been ${status.toLowerCase()}`;
...
//         if (io) {
//           // Create notification data for socket
//           const notificationData = {
