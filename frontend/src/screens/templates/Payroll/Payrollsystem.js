...
const PayrollSystem = () => {
  ...
  //         bankAccountNo: row["Bank Account No"]?.toString() || "",
  //         pfNo: row["PF Number"]?.toString() || "",
  //         uanNo: row["UAN Number"]?.toString() || "",
  //         panNo: row["PAN Number"]?.toString() || "",
  ...
  //           department: row["Department"],
  //           designation: row["Designation"],
  //           basicPay: parseFloat(row["Basic Pay"]),
  //           bankName: row["Bank Name"],
  //           bankAccountNo: row["Bank Account No"]?.toString(),
  //           pfNo: row["PF Number"]?.toString(),
  //           uanNo: row["UAN Number"]?.toString(),
  ...
  //         } catch (error) {
  //           failedImports.push({ data: employeeData, error: error.message });
  //         }
  //       }
  ...
  //         showAlert(
  //           `Successfully imported ${successfulImports.length} employees`
  //         );
  //       }
  //       if (failedImports.length > 0) {
  //         showAlert(
  //           `Failed to import ${failedImports.length} employees`,
  //           "warning"
  //         );
  //       }
