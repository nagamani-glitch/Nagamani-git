...
//       // Process feedback data - using the actual structure from feedbackController.js
//       const feedback = feedbackResponse.data;

//       // Calculate total key results from objectives
//       const totalKeyResults = objectives.reduce(
//         (sum, obj) => sum + (parseInt(obj.keyResults) || 0),
//         0
//       );

//       // Calculate objectives at risk - looking for "risk" in description as per your actual data
//       const objectivesAtRisk = objectives.filter(
//         (obj) =>
...
//     // Count by status
//     const completed = allFeedback.filter(
//       (f) => f.status === "Completed"
//     ).length;
//     const inProgress = allFeedback.filter(
//       (f) => f.status === "In Progress"
//     ).length;
//     const notStarted = allFeedback.filter(
...
//     const labels = Object.keys(keyResultsCount).sort(
...
//             icon={<Assessment />}
//             color="#1976d2"
//             trend={<TrendingUp className="trend-up" />}
...
//             color="#d32f2f"
//             trend={
//               dashboardData.stats.objectivesAtRisk > 0 ? (
//                 <TrendingUp className="trend-down" />
//               ) : (
//                 <TrendingDown className="trend-up" />
//               )
//             }
...
//           <Tab label="Objectives" icon={<Assessment />} iconPosition="start" />
//           <Tab label="Feedback" icon={<Comment />} iconPosition="start" />
//           <Tab label="Team Performance" icon={<Group />} iconPosition="start" />
//         </Tabs>
//       </Box>

//       {/* Tab Panels */}
//       <Box className="tab-content" sx={{ mt: 3 }}>
//         {/* Overview Tab */}
//         {tabValue === 0 && (
...
//                   <Tooltip title="Status distribution of all objectives">
...
//                   <Tooltip title="Distribution of feedback by category">
//                     <IconButton size="small">
//                       <Info fontSize="small" />
//                     </IconButton>
//                   </Tooltip>
...
//                   </Typography>
//                   <Tooltip title="Trend of objectives and feedback over time">
//                     <IconButton size="small">
//                       <Info fontSize="small" />
//                     </IconButton>
//                   </Tooltip>
...
//                 <Box className="chart-header">
//                   <Typography variant="h6">
//                     Objectives by Key Results
//                   </Typography>
//                   <Tooltip title="Distribution of objectives by number of key results">
//                     <IconButton size="small">
//                       <Info fontSize="small" />
//                     </IconButton>
//                   </Tooltip>
...
//                     </Typography>
//                   ) : (
//                     <Box className="objective-list">
//                       {dashboardData.objectives.slice(0, 5).map((objective) => (
//                         <Box key={objective._id} className="objective-item">
//                           <Box className="objective-item-header">
//                             <Typography
//                               variant="subtitle1"
...
//                   <Tooltip title="Status distribution of all feedback">
//                     <IconButton size="small">
//                       <Info fontSize="small" />
//                     </IconButton>
//                   </Tooltip>
...
//                           >
//                             <Box className="feedback-item-header">
//                               <Typography
//                                 variant="subtitle1"
...
//                 <Box className="chart-header">
//                   <Typography variant="h6">
//                     Objectives by Team Member
//                   </Typography>
//                   <Tooltip title="Distribution of objectives by team member">
//                     <IconButton size="small">
//                       <Info fontSize="small" />
//                     </IconButton>
//                   </Tooltip>
//                 </Box>
//                 <Box className="chart-body team-performance">
//                   {dashboardData.objectives.length === 0 ? (
//                     <Typography
//                       variant="body1"
...
//                             data: [
//                               dashboardData.objectives.filter(
//                                 (o) => o.objectiveType === "self"
//                               ).length,
//                               dashboardData.objectives.filter(
//                                 (o) => o.objectiveType === "all"
//                               ).length,
//                               dashboardData.objectives.filter((o) => o.archived)
//                                 .length,
//                               dashboardData.objectives.length -
//                                 dashboardData.objectives.filter(
//                                   (o) => o.archived
//                                 ).length,
//                             ],
...
//                   <Tooltip title="Distribution of feedback by team member">
//                     <IconButton size="small">
//                       <Info fontSize="small" />
//                     </IconButton>
//                   </Tooltip>
...
//                               dashboardData.feedback.requestedFeedback
//                                 ?.length || 0,
//                               dashboardData.feedback.feedbackToReview?.length ||
//                                 0,
//                               dashboardData.feedback.anonymousFeedback
//                                 ?.length || 0,
//                             ],
...
//                               </Typography>
//                               <Typography variant="body2" fontWeight="bold">
//                                 {dashboardData.feedback.selfFeedback?.length ||
//                                   0}
//                               </Typography>
//                             </Box>
//                             <Box
...
//                               </Typography>
//                               <Typography variant="body2" fontWeight="bold">
//                                 {dashboardData.feedback.feedbackToReview
//                                   ?.length || 0}
//                               </Typography>
//                             </Box>
//                             <Box
...
// // Stat Card Component
// const StatCard = ({ title, count, icon, color, trend, trendText }) => {
//   return (
//     <Card className="stat-card">
//       <CardContent>
//         <Box className="stat-card-header" sx={{ color }}>
//           {icon}
