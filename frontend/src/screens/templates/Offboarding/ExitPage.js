        ...
        <div className="offboarding-list">
              ...
              >
                                                  ...
                                                  >
                                                    ...
                                                    <DialogContent sx={{ padding: isMobile ? "16px" : "24px" }}>
                                                      <Grid container spacing={isMobile ? 2 : 3}>
                                                        ...
                                                        <Grid item xs={12} md={8}>
                                                          <Paper variant="outlined" sx={{ p: isMobile ? 2 : 3, borderRadius: 2, mb: 3 }}>
                                                            <Typography
                                                              variant="h6"
                                                              sx={{ mb: 2, color: "#1976d2", fontWeight: 600 }}
                                                            >
                ...
                {selectedEmployee.stage === "Clearance Process" && (
                  <Paper variant="outlined" sx={{ p: isMobile ? 2 : 3, borderRadius: 2 }}>
                    ...
                    {selectedEmployee.exitChecklistCompleted && !selectedEmployee.officiallyOffboarded && (
                ...
                {selectedEmployee.documents && selectedEmployee.documents.length > 0 && (
                  <Paper variant="outlined" sx={{ p: isMobile ? 2 : 3, borderRadius: 2, mt: 3 }}>
                    <Typography
                      variant="h6"
                      sx={{ mb: 2, color: "#1976d2", fontWeight: 600 }}
                    >
                    ...
                    <List>
                      {selectedEmployee.documents.map((doc, index) => (
                        <ListItem key={index} divider={index < selectedEmployee.documents.length - 1}>
                          <ListItemIcon>
          ...
          {!selectedEmployee.officiallyOffboarded && (
            <DialogActions sx={{ p: 2 }}>
              ...
              {selectedEmployee.stage !== offboardingStages[offboardingStages.length - 1].stageName && (
                <Button
                  variant="contained"
                  color="primary"
