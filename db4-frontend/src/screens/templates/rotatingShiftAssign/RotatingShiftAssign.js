...
//     const allIds = currentData.map((req) => req.id);
...
//     const currentData = tabValue === 0 ? shiftRequests : allocatedShifts;
//     const setData = tabValue === 0 ? setShiftRequests : setAllocatedShifts;
    
//     const updatedData = currentData.map(req => 
//       selectedAllocations.includes(req.id) ? {...req, status: 'Approved'} : req
//     );
//     setData(updatedData);
//     setSelectedAllocations([]);
//     setShowSelectionButtons(false);
...
//     const updatedData = currentData.map(req => 
//       selectedAllocations.includes(req.id) ? {...req, status: 'Rejected'} : req
//     );
//     setData(updatedData);
//     setSelectedAllocations([]);
//     setShowSelectionButtons(false);
...
//       req => !selectedAllocations.includes(req.id)
//     );
...
//     const updatedData = currentData.map(req =>
//       req.id === editingShift.id ? updatedShift : req
//     );
//     setData(updatedData);
...
//     const filteredData = currentData.filter(req => req.id !== id);
//     setData(filteredData);
//   };
//   return (
//     <Box>
...
//                   selected={selectedAllocations.includes(request.id)}
//                   sx={{ cursor: "pointer" }}
//                 >
//                   <TableCell padding="checkbox">
//                     <Checkbox
//                       checked={selectedAllocations.includes(request.id)}
//                       onClick={(e) => {
//                         e.stopPropagation();
//                         const newSelected = selectedAllocations.includes(request.id)
//                           ? selectedAllocations.filter(id => id !== request.id)
//                           : [...selectedAllocations, request.id];
//                         setSelectedAllocations(newSelected);
//                         setShowSelectionButtons(newSelected.length > 0);
//                       }}
//                       onChange={() => {}}
...
//                           height: 32,
//                           borderRadius: "50%",
//                           bgcolor: request.id % 2 === 0 ? "primary.main" : "secondary.main",
//                           color: "white",
//                           display: "flex",
//                           alignItems: "center",
...
//                   <TableCell>{request.requestedTill}</TableCell>
...
//                       <Edit fontSize="small" />
//                     </IconButton>
//                     <IconButton color="error" onClick={(e) => handleDelete(request.id, e)}>
