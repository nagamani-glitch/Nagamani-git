...
//         action.id === editingAction.id ? { ...formData, id: action.id } : action
//       ));
//     } else {
//       setActions(prev => [...prev, { ...formData, id: Date.now() }]);
//     }
//     handleClose();
//   };
...
//     const matchesSearch = action.employee.toLowerCase().includes(searchQuery.toLowerCase()) ||
//                          action.description.toLowerCase().includes(searchQuery.toLowerCase());
//     const matchesFilter = filterStatus === 'all' || action.status === filterStatus;
...
//               variant="contained"
//               onClick={handleSave}
//               disabled={!formData.employee || !formData.action}
//             >
